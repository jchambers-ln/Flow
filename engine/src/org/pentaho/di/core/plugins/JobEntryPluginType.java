...
@PluginTypeCategoriesOrder(
  getNaturalCategoriesOrder = {
    ...
    "JobCategory.Category.Conditions", "JobCategory.Category.Scripting", "JobCategory.Category.BulkLoading","JobCategory.Category.DataQuality", "JobCategory.Category.XML",
    ...
    "JobCategory.Category.Deprecated","JobCategory.Category.BigData" }, i18nPackageClass = JobMeta.class )
